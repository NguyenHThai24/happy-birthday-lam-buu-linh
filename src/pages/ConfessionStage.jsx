...
const ConfessionStage = ({ onComplete }) => {
  ...
  const confessionContent = useMemo(
    () => [
      ...
      "về sự trưởng thành, về cách suy nghĩ chính chắn.",
      ...
      "em đau khổ cũng là do em chọn",
      "em lúc nào cũng sẽ chọn yêu chị,",
      "em yêu chị vô điều kiện,",
      "em không giỏi ăn nói lời ngọt ngào,",
      "em chỉ ước em có thể suy nghĩ tốt hơn,",
      "để không nói ra những lời làm tổn thương chị.",
      "Em xin lỗi vì điều đó. Mong rằng chị tha thứ cho em.",
      "Nếu được em vẫn mong được chị cho cơ hội,",
      "bao lâu em cũng sẽ chờ đợi.",
      "",
      ...
      "tâm sự trò truyện cùng nhau sau ngày làm việc mệt mỏi,",
