...
const ConfessionStage = ({ onComplete }) => {
  ...
  const confessionContent = useMemo(
    () => [
      ...
      "thì em vẫn sẽ ở đây, chia sẻ sự mệt mỏi cùng chị.",
      ...
      "Em yêu chị là do em chọn",
      "cũng như em chọn chấp nhận mọi",
      "hạnh phúc hay nỗi đau.",
      "Dù thế nào, em cũng sẽ chọn yêu chị,",
      "bằng một tình yêu vô điều kiện.",

      "Em không khéo léo trong cách ăn nói,",
      "cũng chẳng giỏi trao lời ngọt ngào.",
      "Em chỉ ước mình có thể tinh tế hơn,",
      "để không vô tình thốt ra những lời",
      "khiến chị phải buồn lòng.",
      "Em thật lòng xin lỗi,",
      "mong chị có thể tha thứ cho em.",

      "Nếu có thể, em vẫn luôn hi vọng",
      "chị cho em một cơ hội.",
      "Em sẵn lòng chờ đợi chị, dù là bao lâu.",
      "Em không đòi hỏi gì nhiều,",
      "chỉ mong mỗi tối được chúc chị ngủ ngon,",
      "mỗi ngày đi làm được thấy chị cười.",

      "Em không biết tương lai sẽ ra sao,",
      "nhưng hiện tại em chỉ biết",
      "em thật sự rất rất rất thích chị.",

      "Bây giờ, em không cần chị đáp lại tình cảm này,",
      "chỉ cần chị xem em là người bạn",
      "người em hay người đồng nghiệp là tốt rồi.",

      "Em sẽ trân trọng mọi khoảnh khắc bên chị,",
      "em chỉ mong được cùng chị chơi đánh cầu,",
      "tâm sự trò chuyện cùng nhau",
      "sau ngày làm việc mệt mỏi,",
      "đó đã là điều hạnh phúc với em rồi.",
  ...
  return (
    <div
      ...
      //   backgroundImage: "url('/bg-letter.jpg')",
      // }}
      className="relative min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-blue-100 overflow-hidden flex flex-col items-center justify-center p-2 sm:p-4"
    >
      ...
      <AnimatePresence>
        {showLetter && (
          <>
            {/* Phần lá thư */}
            <motion.div
              className="relative z-10 w-full max-w-4xl mx-2 sm:mx-4 mb-4"
              initial={{ opacity: 0, scale: 0.8 }}
              animate={{ opacity: 1, scale: 1 }}
              transition={{ duration: 1.2, type: "spring" }}
            >
              {/* Paper với background image và chiều cao responsive */}
              <div
                className="relative border-l-4 border-blue-300 shadow-2xl overflow-hidden bg-cover bg-center bg-no-repeat"
                style={{
                  height: `${letterHeight}px`,
                  backgroundImage: "url('/bg-letter.jpg')",
                }}
              >
                {/* Overlay để làm nổi bật chữ trên background */}
                ...
                >
                  ...
                  {/* Chữ ký trong thư - chỉ hiển thị khi đến cuối */}
                  {!isTyping &&
                    currentLineIndex >= confessionContent.length && (
                      <motion.div
                      ...
                      >
                        <div className="inline-block text-center">
                          ...
                          <div className="w-40 sm:w-40 md:w-48 h-0.5 bg-blue-400 mb-2 opacity-60 mx-auto" />
